...
<html lang="en">
  <head>
    ...
    <title>Create Shop Owner Account</title>
  </head>
  <body>
    <?php
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-10 outer" style="height: 600px; margin-top: 40px;">
          <h1 class="text-center"><b>Register Shop Owner's account</b></h1>
          <div class="row">
            <div class="col-1"></div>
            <div class="col-10" style="background-color: rgba(212, 172, 13, 0.3); height: 540px; border-radius: 20px; box-shadow: 0px 0px 40px 20px inset black;">
              ...
              <form action="so_createAccountPHP.php" method="post">
                <div class="form-group">
                  <label style="font-size: 15px; margin-top: 0" for="name">Owner's Name:</label>
                  <input type="text" class="form-control" placeholder="Enter Shop Owner's Name" id="name" name="name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label style="font-size: 15px" for="shopName">Shop Name</label>
                  <input type="text" class="form-control" placeholder="Enter Shop Name" id="shopName" name="shopName">
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                  ...
                  <button style="margin-top: 0; margin-left: 50px;" type="submit" name="so_create" class="btn btn-primary">Register</button>
                </div>
              </form>
            </div>
            <div class="col-1"></div>
