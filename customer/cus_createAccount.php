...
<html lang="en">
  ...
  <body>
    <?php require_once 'cus_createAccountPHP.php' ?>
    <?php
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-10 outer" style="height: 600px; margin-top: 40px;">
          <h1 class="text-center"><b>Register your account</b></h1>
          <div class="row">
            <div class="col-1"></div>
            <div class="col-10" style="background-color: rgba(212, 172, 13, 0.3); height: 540px; border-radius: 20px; box-shadow: 0px 0px 40px 20px inset black;">
              ...
              <form action="cus_createAccountPHP.php" method="post">
                ...
                <div class="text-center">
                  <button style="border-radius: 25px; margin-top: 0; padding: 6px 30px;" class="btn btn-danger" formaction="cus_login.php">Back</button>
                  <button style="margin-top: 0; margin-left: 50px;" type="submit" class="btn btn-primary" name="cus_create">Register</button>
                </div>
              </form>
            </div>
            <div class="col-1"></div>
