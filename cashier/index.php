...
<html lang="en">
  ...
  <body>
    <?php require_once 'cashier_loginPHP.php' ?>
    <?php
        ...
        <div class="col-8 outer">
          ...
          <div class="row">
            ...
            <div class="col-10" style="background-color: rgba(212, 172, 13, 0.3); height: 380px; border-radius: 20px; box-shadow: 0px 0px 40px 20px inset black;">
              ...
              <form action="cashier_loginPHP.php" method="post" style="margin-left: 10px;">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" name="cashier_login" style="margin-left: 0px;">Login</button></a>
                </div>
              </form>
            </div>
            <div class="col-1"></div>
